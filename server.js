...
const corsOptions = {
  origin: [
    'capacitor://localhost',      // Allow native iOS and Android
    'http://localhost',           // Allow native iOS and Android
    'https://www.solura.uk',      // Allow your own website
    'https://solura.uk'           // Allow your own website without www
    // Add any other domains you need for testing, e.g., http://localhost:8080
  ],
  credentials: true,
